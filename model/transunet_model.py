...
class TransUNet(nn.Module):
    ...
    def forward(self, x):
        ...
        f1 = seq1.view(seq1.shape[0],math.sqrt(seq1.shape[1]),math.sqrt(seq1.shape[1]),seq1.shape[2])
        print("f1生成完毕")
        seq2 =self.transformer2(x)
        f2 = seq1.view(seq2.shape[0],math.sqrt(seq2.shape[1]),math.sqrt(seq2.shape[1]),seq2.shape[2])
        print("f2生成完毕")
        seq3 =self.transformer3(x)
        f3 = seq1.view(seq3.shape[0],math.sqrt(seq3.shape[1]),math.sqrt(seq3.shape[1]),seq3.shape[2])
        print("f3生成完毕")
